from sparkproxy.http.middleware import Middleware, RetryDomainsMiddleware
from sparkproxy.http import qn_http_client
...
class TestMiddleware:
    ...
    def test_retry_domains(self, mock_server_addr):
        ...
        ret, resp = qn_http_client.get(
            '{scheme}://fake.pysdk.sparkproxy.com/echo?status=200'.format(
                scheme=mock_server_addr.scheme
            ),
            middlewares=[
                RetryDomainsMiddleware(
                    backup_domains=[
                        'unavailable.pysdk.sparkproxy.com',
        ...
        # ['bef_rec0', 'bef_rec1', 'bef_rec2'] are 'fake.pysdk.sparkproxy.com' with retried 3 times
        # ['bef_rec3', 'bef_rec4', 'bef_rec5'] are 'unavailable.pysdk.sparkproxy.com' with retried 3 times
    ...
    def test_retry_domains_fail_fast(self, mock_server_addr):
        ...
        # ['bef_rec0'] are 'fake.pysdk.sparkproxy.com' with fail fast
